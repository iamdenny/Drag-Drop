...
dny.Draggable = jindo.$Class({
	...
	_onMouseMove : function(we) {
		we.stopBubble();
		var oPos = we.pos();
		var nX = parseInt(oPos.clientX, 10) - this._nGapX;
		var nY = parseInt(oPos.clientY, 10) - this._nGapY;
	...
	_cloneDraggableElement : function() {
		...
		this._welClonedDraggable.css({zIndex:9999});
	...
	_calculateGapBetweenElementAndMouse : function(nX, nY) {
		this._nGapX = parseInt(nX, 10) - parseInt(this._welDraggable.css("left"), 10);
		this._nGapY = parseInt(nY, 10) - parseInt(this._welDraggable.css("top"), 10);
	},
	...
	_setClonedDraggableElementsPosition : function(nX, nY) {
		if(nX > 0 && nX < this._aWindowSize.width){
			this._welClonedDraggable.css("left", parseInt(nX, 10));
		}
		if(nY > 0 && nY < this._aWindowSize.height){
			this._welClonedDraggable.css("top", parseInt(nY, 10));
		}
	},
